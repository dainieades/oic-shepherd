...
const MONTH_NAMES_FDP = [
  'January', 'February', 'March', 'April', 'May', 'June',
  'July', 'August', 'September', 'October', 'November', 'December',
];
const DAY_HEADERS_FDP = ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'];
...
function FloatingCalendar({
  ...
  // Align to trigger width and left edge
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '4px 14px' }}>
          <span style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)' }}>
            {MONTH_NAMES_FDP[viewMonth]} {viewYear}
          </span>
