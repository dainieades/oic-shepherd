...
export default function PersonPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!person) {
    return <div className="text-text-muted pt-16 text-center">Person not found</div>;
  }
    ...
    <div className="person-page-shell">
      <div className="person-content-wrapper pb-8">
        ...
        <div className="bg-bg z-header sticky top-0 flex h-[3.375rem] items-center justify-between">
          ...
          <span className="person-nav-title text-14 text-text-secondary flex-1 overflow-hidden px-2 text-center font-medium text-ellipsis whitespace-nowrap">
            {firstName}
          </span>
            ...
            {activeTab === 'info' ? (
              canEdit && (
                <button
                  ...
                  className="bg-sage text-on-sage flex cursor-pointer items-center gap-[0.3125rem] rounded-xs border-none font-semibold whitespace-nowrap transition-[height,padding,font-size] duration-[250ms] ease-in-out"
                  style={{
              ...
              canManage && (
                <button
                  ...
                  className="bg-sage text-on-sage flex cursor-pointer items-center gap-1 rounded-xs border-none font-semibold whitespace-nowrap transition-[height,padding,font-size] duration-[250ms] ease-in-out"
                  style={{
                    height: scrolled ? 30 : 36,
            ...
            {canEdit && (
              <div ref={kebabRefs.setReference}>
                <button
                  ...
                  className="bg-surface border-border text-text-muted flex cursor-pointer items-center justify-center rounded-full border transition-[width,height] duration-[250ms] ease-in-out"
                  style={{
                ...
                {showKebab &&
                  ...
                  createPortal(
                    <div
                      ...
                      className="bg-surface border-border z-dropdown shadow-elevated overflow-hidden rounded-md border"
                    ...
                    >
                      {activeTab !== 'info' && (
                        <button
                          ...
                          className="border-border-light text-14 text-text-primary flex w-full cursor-pointer items-center gap-2.5 border-b border-none bg-transparent px-4 py-[0.8125rem] text-left"
                        >
                      ...
                      <button
                        ...
                        className="text-14 text-red flex w-full cursor-pointer items-center gap-2.5 border-none bg-transparent px-4 py-[0.8125rem] text-left"
                      >
                        <Trash size={16} />
                        Delete
                      </button>
        ...
        <div className="person-body">
          <div className="person-sidebar-col">
            ...
            <div className="person-header-block flex gap-4 pt-7 pb-5">
              {/* Avatar */}
              <PhotoAvatar
                photo={person.photo}
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-[0.3125rem] flex items-center justify-between gap-[0.4375rem]">
                  <div className="person-name-row min-w-0">
                    <h1 className="person-name-h1 text-26 text-text-primary tracking-tight-2 leading-tight font-extrabold">
                      {fullName(person)}
                    </h1>
                    {person.alternativeName && (
                      <span className="person-alt-name text-14 text-text-muted font-normal">
                        {person.alternativeName}
                      </span>
                    )}
                  </div>
                  ...
                  {groups.map((g) => (
                    <>
                      ...
                      <button
                        ...
                        className="text-11 rounded-pill bg-blue-light text-blue cursor-pointer border-none px-[0.4375rem] py-0.5 font-semibold"
                      >
                        {g.name}
                      </button>
                    </>
            ...
            {shepherds.length === 0 && canEdit && (
              ...
              >
                <div
                  className="mb-4 flex items-center justify-between gap-2 rounded-md"
                  style={{
                ...
                >
                  <div className="flex min-w-0 items-center gap-2">
                    ...
                    <span
                      className="text-13 text-left font-medium"
                  ...
                  <span
                    className="text-12 inline-flex shrink-0 items-center gap-[0.1875rem] font-semibold"
                    style={{ color: 'var(--amber)' }}
                  >
                    Assign
                    <CaretRight size={12} />
          ...
          <div className="person-main-col">
            ...
            {visibleTabs.length > 1 && (
              <div className="person-tabs-mobile bg-bg border-border-light z-subheader sticky top-[3.375rem] mb-5 flex border-b-2">
                {visibleTabs.map((t) => (
                  <button
                    key={t}
                    onClick={() => setTab(t as Tab)}
                    className="text-13 -mb-0.5 flex flex-1 cursor-pointer items-center justify-center gap-[0.3125rem] border-none bg-transparent py-[0.625rem] transition-[color,border-bottom-color] duration-[180ms] ease-in-out"
                    style={{
                  ...
                  >
                    ...
                    {t === 'todos' && incompleteTodosCount > 0 && (
                      <span className="text-11 bg-sage text-on-sage rounded-sm px-1.5 py-[0.0625rem] leading-normal font-semibold">
                      ...
                      <InfoRow
                        ...
                        value={
                          <Link
                            ...
                            className="text-blue inline-flex items-center gap-1 no-underline"
                          >
                            {family.label}
                            <CaretRight size={13} />
                          </Link>
                ...
                <InfoSection title="Church">
                  ...
                  {person.isShepherd && (
                    <>
                      ...
                      <div className="border-border-light flex items-center justify-between gap-3 border-b px-4 py-[0.6875rem]">
                        ...
                        <div className="flex items-center gap-1.5">
                          {sheep.length > 2 && (
                            <button
                              ...
                              className="text-12 text-text-secondary flex cursor-pointer items-center gap-1 border-none bg-transparent p-0 font-medium"
                            >
                              {sheepExpanded ? 'Hide' : 'Show all'}
                              {!sheepExpanded && (
                                <span className="text-11 rounded-pill bg-sage-light text-sage px-[0.4375rem] py-[0.0625rem] font-semibold">
                                  {sheep.length}
                                </span>
                              )}
                              <CaretDown
                      ...
                      {sheep.length > 0 && (sheep.length <= 2 || sheepExpanded) && (
                        <div className="border-border-light flex flex-col gap-2 border-b px-4 pt-2 pb-3">
                          {sheep.map((s) => {
                            return (
                              <Link
                                key={s.id}
                              ...
                              >
                                ...
                                <span className="text-13 text-blue font-medium">{fullName(s)}</span>
                                {s.alternativeName && (
                                  <span className="text-12 text-text-muted">
                                    {s.alternativeName}
                                  </span>
                                )}
                                <CaretRight size={11} color="var(--blue)" className="ml-auto" />
                              </Link>
                            );
                          })}
                        </div>
                        ...
                        <div className="flex flex-wrap justify-end gap-[0.3125rem]">
                          {groups.map((g) => (
                            <button
                              key={g.id}
                              onClick={() => setPreviewGroupId(g.id)}
                              className="text-11 rounded-pill bg-blue-light text-blue cursor-pointer border-none px-[0.5625rem] py-[0.1875rem] font-medium"
                            >
                              {g.name}
                            </button>
                          ))}
                  ...
                  <InfoSection title="Contact">
                    {person.phone && (
                      <InfoRow
                        ...
                        label="Phone"
                        value={
                          <a href={`tel:${person.phone}`} className="text-blue no-underline">
                            {person.phone}
                          </a>
                        }
                      />
                    ...
                    {person.homePhone && (
                      <InfoRow
                        ...
                        label="Home Phone"
                        value={
                          <a href={`tel:${person.homePhone}`} className="text-blue no-underline">
                            {person.homePhone}
                          </a>
                        }
                      />
                    ...
                    {person.email && (
                      <InfoRow
                        ...
                        label="Email"
                        value={
                          <a href={`mailto:${person.email}`} className="text-blue no-underline">
                            {person.email}
                          </a>
                        }
                      />
                      ...
                      <InfoRow
                        ...
                        value={
                          <a
                            ...
                            className="text-blue block text-right leading-normal whitespace-pre-wrap no-underline"
                          >
                            {person.homeAddress}
                          </a>
                        }
                ...
                <InfoSection title="Record info">
                  ...
                  {person.createdBy &&
                    (() => {
                      ...
                      return creator ? (
                        <InfoRow label="Added by" value={creator.name} muted />
                      ) : null;
                    })()}
                  <InfoRow
                    label="Last edited"
