      ...
      <table width="100%" style="max-width:520px;background:#fff;border-radius:12px;padding:32px;box-shadow:0 1px 4px rgba(0,0,0,.08)">
        <tr><td>
          ...
          <div style="margin:28px 0 0;text-align:center">
            <a href="${APP_URL}/signin" style="display:inline-block;padding:12px 28px;background:#705a8c;color:#fff;font-size:14px;font-weight:600;text-decoration:none;border-radius:8px">Log in to OIC Shepherd</a>
          </div>
...
export function personUpdatedEmail(personName: string, updatedByName: string, changes: ProfileChange[] = []): EmailTemplate {
  return {
...
export function ownProfileUpdatedEmail(updatedByName: string, changes: ProfileChange[] = []): EmailTemplate {
  return {
...
export const EMAIL_PREVIEW_REGISTRY: { label: string; subject: string; html: string }[] = [
  ...
  { label: 'To-do reminder set', ...todoCreatedEmail('Call David about his job situation', '2026-04-30', 'day_before_9am') },
];
